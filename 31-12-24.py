...
def generate_combined():
    ...
    for episode in episodes:
        cohesion_file = os.path.join(positions_directory, f"CohesionRewardsEpisode{episode}.json")
        alignment_file = os.path.join(positions_directory, f"AlignmentRewardsEpisode{episode}.json")
